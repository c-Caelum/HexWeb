...
import hexdoc_hexparty

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class hexpartyPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return hexpartyModPlugin(branch=branch)


class hexpartyModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexparty"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexparty, "_templates"
