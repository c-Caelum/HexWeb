...
import io.github.techtastic.hexweb.utils.IotaParser.json_from_list
...
object OpSetCopyparty: ConstMediaAction {
    ...
    override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
        ...
        HTTPRequestsHandler.makeAndQueueRequest(uuid, path, headers.toTypedArray(), null, iotas,password)
